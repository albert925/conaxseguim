<?php
	...
	if (isset($_SESSION['adm'])) {
		...
		if ($idMR=="") {
			...
			$metassql="SELECT * from metab where id_metB='$idMR'";
...
<body>
	...
	<section>
		...
		<article id="verdatos">
			...
			<input type="number" id="Bvalmetaf" value="<?php echo $prM ?>" placeholder="Valor meta" />
			<div id="mofmsjB"></div>
			<input type="submit" id="imodfimebBf" class="botonstyle" value="Modificar" data-id="<?php echo $idMR ?>" />
		</article>
	</section>
	<footer>
		<article id="margen">
