...
<body>
	...
	<section>
		...
		<article id="sinscroll">
				<?php
					$metassql="SELECT * from metas order by id_meta asc";
			...
			<table border="1" id="segitable" class="tamne" title="la Tabla No es adaptable">
				...
				<tr>
					<td><b>Meta</b></td>
					<td><b style="color:#00A5D4;;">$<?php echo "$prM"; ?></b></td>
				</tr>
				<tr>
					<td><b>Restante</b></td>
					<td><b style="color:#FF3C3C;">$<?php echo "$resM"; ?></b></td>
				</tr>
				<tr>
					<td colspan="2">
			...
			<table border="1" id="segitable" title="la Tabla No es adaptable">
				<?php
					...
					where seguimiento.mes_in='$MHB' and seguimiento.year_in='$yearM' and empresas.depart_emp='$dpM' 
				...
				<tr>
					<td colspan="4"></td>
					<td id="resulrap">$<b style="color:#FF3C3C;"><?php echo "$sumarape"; ?></b></td>
				</tr>
				<?php
					}
				?>
