...
<body>
	...
	<section>
		...
		<article id="verdatos">
			...
			<input type="number" id="valmeta" placeholder="Valor meta" />
			<div id="mesjmetas"></div>
			<input type="submit" id="ingrmeta" class="botonstyle" value="Ingresar" />
		</article>
	</section>
	<footer>
		<article id="margen">
