...
<body>
	...
	<section>
		...
		<article id="verdatos">
			<input type="text" id="nameprove" required="required" placeholder="Nombre proveedor" />
			<input type="number" id="precioprove" required="required" placeholder="Precio del Proveedor solo números" />
			<div id="mesingprovees"></div>
			<input type="submit" value="Ingresar" id="ingrprove" class="botonstyle" />
		</article>
	</section>
	<footer>
		<article id="margen">
