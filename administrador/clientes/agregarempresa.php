...
<body>
	...
	<section>
		...
		<article id="verdatos">
			...
			<input type="text" id="nameempre" required="required" placeholder="Nombre de la Empresa" />
			<input type="text" id="nitempre" placeholder="Nit de la Empresa" />
			<input type="tex" id="direempre" placeholder="Direcion Empresa" />
			<input type="tel" id="telempre" placeholder="Teléfono" />
			<select id="paisempr">
			...
			<div id="mesingempresa"></div>
			<input type="submit" value="Ingresar" id="ingrenempresa" class="botonstyle" />
		</article>
	</section>
	<footer>
		<article id="margen">
