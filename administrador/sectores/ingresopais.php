...
<body>
	...
	<section>
		...
		<article id="verdatos">
			<input type="text" id="newpais" required="required" placeholder="Ingree nombre País" />
			<div id="mespaisNEW"></div>
			<input type="submit" value="Ingresar" id="ingrenexpais" class="botonstyle" />
		</article>
	</section>
	<footer>
		<article id="margen">
