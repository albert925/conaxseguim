...
<body>
	...
	<section>
		...
		<article id="verdatos">
			<input type="text" id="newciudad" required="required" placeholder="Ingrese nombre ciudad" />
			<div id="mesciudadNEW"></div>
			<input type="submit" value="Ingresar" id="ingrenexciudad" class="botonstyle" />
		</article>
	</section>
	<footer>
		<article id="margen">
