<?php
	...
	if (isset($_SESSION['adm'])) {
		...
		$mes=$_GET['mesEV'];
		$yeaH=$_GET['yearEV'];
		if ($mes=="0" || $yeaH=="0" || $yeaH=="0000" || $yeaH=="") {
			$fechaut="000-00-00";
			$enfecaql="1";
		}
		else{
			...
			$enfecaql="seguimiento.fecha_ingreso>='$fechaut' and seguimiento.fecha_ingreso<='$fechautb'";
		}
?>
<!DOCTYPE html>
<html lang="es">
	...
	<section>
		...
		<article id="menub">
			...
			<select id="mespor">
				<?php
					for ($mesB=0; $mesB <=12 ; $mesB++) {
						...
						switch ($mesB) {
							case '1':
								$nombmesSelecion="Enero";
								break;
							case '2':
								$nombmesSelecion="Febrero";
								break;
							case '3':
								$nombmesSelecion="Marzo";
								break;
							case '4':
								$nombmesSelecion="Abril";
								break;
							case '5':
								$nombmesSelecion="Mayo";
								break;
							case '6':
								$nombmesSelecion="Junio";
								break;
							case '7':
								$nombmesSelecion="Julio";
								break;
							case '8':
								$nombmesSelecion="Agosto";
								break;
							case '9':
								$nombmesSelecion="Septiembre";
								break;
							case '10':
								$nombmesSelecion="Octubre";
								break;
							case '11':
								$nombmesSelecion="Noviembre";
								break;
							case '12':
								$nombmesSelecion="Diciembre";
								break;
							default:
								$nombmesSelecion="Meses";
								break;
						}
				?>
				<option value="<?php echo $mesB ?>" <?php echo $selMEs ?>><?php echo "$nombmesSelecion"; ?></option>
				<?php
					}
				?>
			</select>
			<select id="yerpor">
				...
				?>
				<option value="<?php echo $Yfr ?>" <?php echo $selyear ?>><?php echo "$Yfr"; ?></option>
				<?php
					}
				?>
			</select>
		...
		<article id="vertables">
			...
			<?php
				...
				$sumJ=0;
				$numerms=0;
				$mysqlver="SELECT * from seguimiento where $enfecaql 
